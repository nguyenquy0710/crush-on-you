    ...
    public class ManageController : BaseController
    {
        ...
        public async Task<ActionResult> Index(ManageMessageId? message)
        {
            ...
            var model = new IndexViewModel
            {
                ...
                BrowserRemembered = await AuthenticationManager.TwoFactorBrowserRememberedAsync(GetUserID.ToString())
            };
            return View(model);
        }
        ...
        {
            var loginInfo = await AuthenticationManager.GetExternalLoginInfoAsync(XsrfKey, GetUserID.ToString());
            if (loginInfo == null)
            {
